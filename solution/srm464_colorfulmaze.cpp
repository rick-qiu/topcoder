...
*    Problem URL: http://community.topcoder.com/stat?c=problem_statement&pm=10741
*******************************************************************************/
#include <vector>
#include <list>
#include <map>
...
double ColorfulMaze::getProbability(vector<string> maze, vector<int> trap) {
    double ret;
    return ret;
}
...
int test0() {
    ...
    ColorfulMaze* pObj = new ColorfulMaze();
    clock_t start = clock();
...
int test11() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.0018936548550000025;
    if(result == expected) {
...
int test17() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.016661613445440003;
    if(result == expected) {
...
int test20() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.3003818832000001;
    if(result == expected) {
...
int test21() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.19694964000000004;
    if(result == expected) {
...
int test23() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.07138800000000001;
    if(result == expected) {
...
int test24() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.2749706908640001;
    if(result == expected) {
...
int test25() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.009185498471999998;
    if(result == expected) {
...
int test29() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.0014100112800000016;
    if(result == expected) {
...
int test31() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.5926900399999999;
    if(result == expected) {
...
int test33() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.22381764480000005;
    if(result == expected) {
...
int test35() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.21327832799999996;
    if(result == expected) {
...
int test36() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.12306270239999997;
    if(result == expected) {
...
int test41() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.11260409999999998;
    if(result == expected) {
...
int test49() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.6610752000000001;
    if(result == expected) {
...
int test52() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.34491599999999994;
    if(result == expected) {
...
int test55() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.5493886551999999;
    if(result == expected) {
...
int test57() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.8310000000000001;
    if(result == expected) {
...
int test58() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.02963041233312;
    if(result == expected) {
...
int test59() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.22410431999999997;
    if(result == expected) {
...
int test61() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.9957999999999999;
    if(result == expected) {
...
int test64() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.03764347200000001;
    if(result == expected) {
...
int test65() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.16359168000000002;
    if(result == expected) {
...
int test66() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.9808475999999999;
    if(result == expected) {
...
int test68() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.28302400559999996;
    if(result == expected) {
...
int test70() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.8508800000000001;
    if(result == expected) {
...
int test71() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.22062124000000002;
    if(result == expected) {
...
int test72() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.23478794799999997;
    if(result == expected) {
...
int test73() {
    ...
    clock_t end = clock();
    delete pObj;
    double expected = 0.24055456320000002;
    if(result == expected) {
...
int test74() {
    vector<string> maze = {"$ABBDGFBDDEAFCGBBFEDDCCGCCDDGDCFABGCGEAFGEDGACDAEB", "EEFAFADGDDBFFFBCDCBDADFDEFEBFFBCAFAGFEEFBFFACBAAGG", "FECFBBADDCBCGDADBCADABDDFAFEFBAGCCGADGBBCCEECEBBDA", "ABDADGGBGDDAGAAAAACAEECAGABDAABECCEBDFAECFBEBCCBDD", "GABEADBCBGFDDFCDFDGADFCBCADBDCBEFDGDEFFFCDABEAFABF", "ADDDCGGBEFDBCGEDGBEDABADAGEAEBDACFGBEDCCBEBFFBCCAG", "EBBDBGFDGEECDCEEGCBGFEBEFGACDFACDFGCGCDEDCCGGEGGGA", "EFGABABCCGFACEFCBAFEFGGBFACCEDGACBAABGDEFEADGCDGDA", "BDDGGEFAGABDBEAFAFCCCGCEEGBCBEFGBFGCGFGBDAEDDACBCC", "BBDFGBGDEEACCDGDGGDFDBCEEFGEEAGDDBACGCADBDDCCDFBGC", "FCDFGEEEEDFBAGEEBDGCFEAAFFGGEDDCFDGCGABFBCACEDGEEG", "BBDBBEADEEEFGGBGDEABDEADEEAFBAAFCDEAABGDFECEACEEDA", "BGFDBCFFABDBFDCBDBDGAFCCCGEAADDFDABAECBACGBFAEAEFB", "EBECAFAADACEEDGDDDFBFCGGGGFDBBEDAF
BBAAADGCBCABCADABBEBDCGADCCDBE", "CDGGGEDBFAAACAGCGEDAEDAGCGFGGACFDBFBDFFEAGAEADBCEB", "ACDEDBGDBFFGGBEGDGAGDDABFFDGCDFGBGCEBCCEACFFGAGFCD", "FDGCAGEEAADAACBFGFCEGFEABBAGECBGADEBABBFBEDCAFADDD", "GBGGDCCDCACFFAEEBGDEEFBAEBDBADDCAGEEFGGFBGEDACGAC!"};
    vector<int> trap = {50, 50, 50, 50, 50, 50, 50};
    ColorfulMaze* pObj = new ColorfulMaze();
    clock_t start = clock();
    double result = pObj->getProbability(maze, trap);
    clock_t end = clock();
    delete pObj;
    double expected = 0.140625;
    if(result == expected) {
...
/*******************************************************************************
*    Top Submission URL: 
*    http://community.topcoder.com/stat?c=problem_solution&cr=310333&rd=14149&pm=10741
********************************************************************************
#include <algorithm> 
#include <cctype> 
#include <cmath> 
...
double memo[50][50][1<<7][8]; 
int cookie[50][50], COOKIE; 
...
public: 
   ...
   double rec( int r, int c, int mask, int t ) { 
      if( memo[r][c][mask][t] >= -1.0 ) return memo[r][c][mask][t]; 
      ...
      if( a[r][c] == 'A' + t ) { 
         ...
         for( int d = 0; d < 4; ++d ) { 
            ...
            if( a[rr][cc] == '#' || a[rr][cc] == 'A' + t ) continue; 
            if( a[rr][cc] == '!' ) return 1.0; 
            if( isalpha(a[rr][cc]) && !((mask>>(a[rr][cc]-'A'))&1) ) { 
               int color = a[rr][cc]-'A'; 
               ret = max( ret, (1-p[color]) * rec( rr, cc, mask | (1<<color), t ) ); 
            } else { 
               ret = max( ret, rec( rr, cc, mask, t ) ); 
            } 
         } 
         return ret; 
      } else { 
         ...
         vector<par> border; 
         ++COOKIE; 
         walk.push_back( par(r,c) ); 
         cookie[r][c] = COOKIE; 
         for( int i = 0; i < walk.size(); ++i ) { 
            for( int d = 0; d < 4; ++d ) { 
               int rr = walk[i].first + dr[d]; 
               int cc = walk[i].second + dc[d]; 
               if( rr < 0 || rr >= R ) continue; 
               if( cc < 0 || cc >= C ) continue; 
               if( a[rr][cc] == '#' || a[rr][cc] == 'A' + t ) continue; 
               if( cookie[rr][cc] == COOKIE ) continue; 
               cookie[rr][cc] = COOKIE; 
               if( a[rr][cc] == '!' ) exit = true; 
               if( isalpha(a[rr][cc]) && !((mask>>(a[rr][cc]-'A'))&1) ) { 
                  border.push_back( par(rr,cc) ); 
               } else { 
                  walk.push_back( par(rr,cc) ); 
               } 
            } 
         } 
         ...
         if( exit ) ret = 1.0; 
            ...
            for( vector<par>::iterator it = border.begin(); it != border.end(); ++it ) { 
               int rr = it->first; 
               int cc = it->second; 
               int color = a[rr][cc]-'A'; 
                
               double p1 = (1-p[color]) * rec( rr, cc, mask | (1<<color), t ); 
               double p2 = t == 7 ? p[color] * rec( rr, cc, mask | (1<<color), color ) : 0.0; 
               ret = max( ret, p1+p2 ); 
            } 
         } 
 
         for( vector<par>::iterator it = walk.begin(); it != walk.end(); ++it )  
            memo[it->first][it->second][mask][t] = ret; 
   ...
   double getProbability( vector <string> maze, vector <int> trap ) { 
      ...
      for( int i = 0; i < 7; ++i ) p[i] = trap[i] / 100.0; 
