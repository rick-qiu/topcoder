...
*    Problem URL: http://community.topcoder.com/stat?c=problem_statement&pm=10457
*******************************************************************************/
#include <vector>
#include <list>
#include <map>
...
int NumericalPerfectionLevel::getLevel(long N) {
    int ret;
    return ret;
}
...
int test0() {
    long N = 4;
    NumericalPerfectionLevel* pObj = new NumericalPerfectionLevel();
    clock_t start = clock();
    int result = pObj->getLevel(N);
    clock_t end = clock();
    delete pObj;
    int expected = 0;
    if(result == expected) {
...
/*******************************************************************************
*    Top Submission URL: 
*    http://community.topcoder.com/stat?c=problem_solution&cr=22753605&rd=13898&pm=10457
********************************************************************************
#include <vector>  
#include <list>  
#include <map>  
