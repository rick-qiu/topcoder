...
*    Problem URL: http://community.topcoder.com/stat?c=problem_statement&pm=11848
*******************************************************************************/
#include <vector>
#include <list>
#include <map>
...
int CaptureFish::getParity(string fish) {
    int ret;
    return ret;
}
...
int test0() {
    string fish = "OXOXO";
    CaptureFish* pObj = new CaptureFish();
    clock_t start = clock();
    int result = pObj->getParity(fish);
    clock_t end = clock();
    delete pObj;
    int expected = 0;
    if(result == expected) {
...
/*******************************************************************************
*    Top Submission URL: 
*    http://community.topcoder.com/stat?c=problem_solution&cr=23062613&rd=14731&pm=11848
********************************************************************************
#include <algorithm>
#include <cctype>
#include <cstdio>
...
class CaptureFish {
public:
  int getParity(string);
};
 
int CaptureFish::getParity(string fish) {
  int n = fish.size(), cnt = 0;
  for (int i = 0; i < n; i++) {
    for (int j = i; j < n; j++) {
      bool flag;
      flag = true;
