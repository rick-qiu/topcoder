...
*    Problem URL: http://community.topcoder.com/stat?c=problem_statement&pm=12355
*******************************************************************************/
#include <vector>
#include <list>
#include <map>
...
int test0() {
    string colors = "RRRR";
    PenguinPals* pObj = new PenguinPals();
    clock_t start = clock();
    int result = pObj->findMaximumMatching(colors);
    clock_t end = clock();
    delete pObj;
    int expected = 2;
    if(result == expected) {
...
/*******************************************************************************
*    Top Submission URL: 
*    http://community.topcoder.com/stat?c=problem_solution&cr=22928694&rd=15486&pm=12355
********************************************************************************
   ...
   int findMaximumMatching( string colors ) { 
     ...
     { 
       ...
       { 
         ...
         for (int k = 0; k < n; k++) 
         { 
           if ((k != i) && (k != j)) ns += colors[k]; 
         } 
         return findMaximumMatching(ns) + 1; 
       } 
     } 
     return n / 2 - 1; 
   } 
