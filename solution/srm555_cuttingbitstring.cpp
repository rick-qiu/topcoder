...
*    Problem URL: http://community.topcoder.com/stat?c=problem_statement&pm=12155
*******************************************************************************/
#include <vector>
#include <list>
#include <map>
...
int test0() {
    string S = "101101101";
    CuttingBitString* pObj = new CuttingBitString();
    clock_t start = clock();
    int result = pObj->getmin(S);
    clock_t end = clock();
    delete pObj;
    int expected = 3;
    if(result == expected) {
...
/*******************************************************************************
*    Top Submission URL: 
*    http://community.topcoder.com/stat?c=problem_solution&cr=22860142&rd=15177&pm=12155
********************************************************************************
...
const ll inf = 4503599627370496LL; 
...
{ 
    public: 
        ...
        { 
            ...
            dp[0] = 0; 
            rep (i, len) { 
                if (dp[i] == -1 || s[i] == '0') continue; 
                repf (j, i, len - 1) { 
                    if (all.find(getnum(s, i, j)) != all.end()) { 
        ...
        ll getnum(string s, int b, int e) { 
            ll num = 0; 
            repf (i, b, e) { 
                num = num * 2 + (s[i] - '0'); 
            } 
