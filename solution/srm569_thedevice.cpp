...
*    Problem URL: http://community.topcoder.com/stat?c=problem_statement&pm=12388
*******************************************************************************/
#include <vector>
#include <list>
#include <map>
...
int test0() {
    vector<string> plates = {"010", "011", "101"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
    delete pObj;
    int expected = 1;
    if(result == expected) {
...
int test2() {
    vector<string> plates = {"01010101", "10101010"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test3() {
    vector<string> plates = {"10010101011", "00010101001", "00100010111", "00101010101", "01010111101"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test5() {
    vector<string> plates = {"1101001011010", "0010000010101", "1010101011110", "1101010100111", "1011111110111"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test97() {
    vector<string> plates = {"000", "011", "001"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test100() {
    vector<string> plates = {"111111", "111111", "111111"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test103() {
    vector<string> plates = {"111111111"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test106() {
    vector<string> plates = {"010", "011", "001"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test109() {
    vector<string> plates = {"00", "00", "00", "00"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test110() {
    vector<string> plates = {"01000100100"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test112() {
    vector<string> plates = {"000", "000", "000"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test116() {
    vector<string> plates = {"1000", "0000"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test124() {
    vector<string> plates = {"1", "1", "1", "1", "1", "1"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test126() {
    vector<string> plates = {"000000000000000", "000000000000000", "000000000000000", "000000000000000"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test127() {
    vector<string> plates = {"0", "0", "0", "0", "0"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
int test128() {
    vector<string> plates = {"11110", "10000"};
    TheDevice* pObj = new TheDevice();
    clock_t start = clock();
    int result = pObj->minimumAdditional(plates);
    clock_t end = clock();
...
/*******************************************************************************
*    Top Submission URL: 
*    http://community.topcoder.com/stat?c=problem_solution&cr=22722891&rd=15489&pm=12388
********************************************************************************
#include <string>
#include <vector>
#include <list>
...
class TheDevice {
  ...
  int minimumAdditional(vector <string> plates) {
    ...
    for (int i = 0; i < plates[0].length(); i ++) {
      int countOne = 0, countZero = 0, tmpAns = 0;
      for (int j = 0; j < plates.size(); j ++) {
        if (plates[j][i] == '1') countOne ++;
        else countZero ++;
      }
      
      if (countZero <= 0) tmpAns ++;
      
      if (countOne < 2) tmpAns += (2 - countOne);
