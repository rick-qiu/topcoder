...
*    Problem URL: http://community.topcoder.com/stat?c=problem_statement&pm=1800
*******************************************************************************/
#include <vector>
#include <list>
#include <map>
...
int test0() {
    ...
    CardCount* pObj = new CardCount();
    clock_t start = clock();
    vector<string> result = pObj->dealHands(numPlayers, deck);
    clock_t end = clock();
    delete pObj;
...
/*******************************************************************************
*    Top Submission URL: 
*    http://community.topcoder.com/stat?c=problem_solution&cr=7390772&rd=4610&pm=1800
********************************************************************************
#include <string>
#include <vector>
#include <cmath>
